...
'''
执行过命令和结果
(venv) D:\CrazyPythonNotes>python D:\CrazyPythonNotes\chapter_ten\argv_test.py
1
D:\CrazyPythonNotes\chapter_ten\argv_test.py

(venv) D:\CrazyPythonNotes>python D:\CrazyPythonNotes\chapter_ten\argv_test.py Python Swift
3
D:\CrazyPythonNotes\chapter_ten\argv_test.py
Python
Swift
...
(venv) D:\CrazyPythonNotes>

'''


'''
前面介绍了使用 PYTHONPATH 环境变量来添加Python模块的加载路径，但这种方式必须预先设置好。
